...
export const depositFormTokenAmountAtom: PrimitiveAtom<string> = atom<string>('')
export const depositFormShareAmountAtom: PrimitiveAtom<string> = atom<string>('')
            ...
            <TxFormInput
              ...
              validate={{
                isNotGreaterThanBalance: (v) =>
                  parseFloat(formatUnits(tokenBalance, vault.decimals as number)) >=
                    parseFloat(v) ||
