...
const TextBanner = (props: TextBannerProps) => {
  ...
  return (
    <div className={classNames('flex flex-col items-center text-center', className)}>
      <span className='font-averta font-bold text-[2.5rem] leading-normal text-pt-bg-purple-darker'>
        Why a Crypto Protocol?
      </span>
      <span className='font-averta font-bold text-[2.5rem] leading-normal mb-6'>
        Because it's 100% Transparent & Free
      </span>
      <span className='max-w-[40%] text-xl text-pt-purple-100 mb-10'>
